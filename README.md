...
Учебный проект: сравнение двух архитектурных подходов для связки NestJS + tRPC.
...
| Монорепо | [monorepo](./monorepo) | Auth / Catalog / Cart разбиты на три отдельных NestJS-сервиса, общающихся по tRPC |
